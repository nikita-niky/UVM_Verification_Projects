...
| | **Mealy FSM** | Overlapping "1011" sequence detection, combinational output generation, and 4-state transition mapping | [`FSM Mealy`](https://github.com/nikita-niky/UVM_Verification_Projects/tree/main/Digital%20Blocks/fsm_mealy_uvm) |
| | **Moore FSM** | Non-overlapping "1011" sequence detection, synchronized glitch-free outputs, reset recovery, and SVA liveness checks | [`FSM Moore`](https://github.com/nikita-niky/UVM_Verification_Projects/tree/main/Digital%20Blocks/fsm_moore_uvm) |
