...
class arbiter_env extends uvm_env;
  ...
  arbiter_agent      agent;
  arbiter_scoreboard scb;
  arbiter_coverage cov;

  function new(string name = "arbiter_env", uvm_component parent);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    scb   = arbiter_scoreboard::type_id::create("scb", this);
    cov   = arbiter_coverage::type_id::create("cov",this);
  endfunction
